...
export function SplitContentSection() {
  return (
    <section className="bg-black py-16 md:py-24 px-6 md:px-12 w-full">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
        <div className="flex flex-col gap-6 max-w-xl">
          <h2 className="text-4xl md:text-5xl font-black text-white tracking-tight leading-tight">
            Ready to reclaim your <br className="hidden sm:inline" />
            focus?
          </h2>
          <p className="text-lg text-white opacity-80 leading-relaxed">
            Join thousands of high-performing teams who have switched to a <br className="hidden sm:inline" />
