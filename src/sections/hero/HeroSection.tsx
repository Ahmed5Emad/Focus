  ...
  return (
    <div className="w-full flex my-16 self-stretch flex-col items-center px-4 md:px-16 lg:px-32">
      <div className="flex mb-4 flex-col w-full md:w-3/4 lg:w-1/2 items-center justify-center gap-2">
        ...
        <div className="flex flex-col md:flex-row mt-10 mb-12 gap-4">
          ...
          <Button
            size="lg"
            variant="outline"
            className="shadow-sm px-8 h-14 font-bold text-lg rounded-xl border-2 hover:bg-muted"
            >
            View Features
          </Button>
        </div>
      ...
      <div className="flex flex-col max-w-7xl w-full items-center content-start px-4 md:px-0">
        <div className="flex flex-col self-stretch content-start w-full rounded-2xl h-[300px] md:h-[600px] gap-2 border border-border bg-card shadow-2xl overflow-hidden relative">
          {/* Faux App Header */}
          <div className="h-14 border-b border-border flex items-center px-6 gap-4 bg-muted/50">
            ...
            <div className="h-8 w-64 bg-card border border-border rounded-md shadow-sm ml-4"></div>
          </div>
          ...
          <div className="flex flex-1 overflow-hidden">
            <div className="w-64 border-r border-border bg-muted/30 p-4 flex flex-col gap-3">
              ...
              <div className="h-6 w-3/4 bg-muted/50 rounded-md mt-4"></div>
            ...
            <div className="flex-1 p-8 flex flex-col gap-6">
              ...
              <div className="flex gap-4">
                <div className="h-32 flex-1 bg-card border-t-4 border-cu-green rounded-xl shadow-sm border border-border p-4"></div>
                <div className="h-32 flex-1 bg-card border-t-4 border-cu-blue rounded-xl shadow-sm border border-border p-4"></div>
                <div className="h-32 flex-1 bg-card border-t-4 border-cu-orange rounded-xl shadow-sm border border-border p-4"></div>
              </div>
              <div className="flex-1 bg-card border border-border rounded-xl shadow-sm flex flex-col">
                <div className="h-12 border-b border-border flex items-center px-4 gap-4">
                  <div className="h-4 w-24 bg-muted rounded"></div>
                  <div className="h-4 w-24 bg-muted rounded"></div>
                </div>
                <div className="p-4 flex flex-col gap-4">
                  <div className="h-12 w-full bg-muted rounded-lg border border-border flex items-center px-4 gap-4">
                    <div className="h-4 w-4 bg-cu-purple rounded-sm"></div>
                    <div className="h-4 w-1/2 bg-muted-foreground/30 rounded"></div>
                    <div className="h-6 w-16 bg-cu-pink/20 rounded-full ml-auto"></div>
                  </div>
                  <div className="h-12 w-full bg-muted rounded-lg border border-border flex items-center px-4 gap-4">
                    <div className="h-4 w-4 bg-cu-blue rounded-sm"></div>
                    <div className="h-4 w-1/3 bg-muted-foreground/30 rounded"></div>
