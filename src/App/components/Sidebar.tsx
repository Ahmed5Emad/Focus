  ...
  return (
    <aside className="bg-white border-[#e2e8f0] border-r border-solid flex flex-col h-screen items-start justify-between pt-[32px] relative shrink-0 w-[256px] sticky top-0">
      <div className="w-full flex flex-col gap-6">
        <div className="flex flex-col gap-[4px] items-start px-[24px] w-full">
        ...
        <div className="px-[16px] w-full">
          <button className="bg-gradient-to-r from-[#7c3aed] to-[#4f46e5] drop-shadow-[0px_4px_6px_rgba(139,92,246,0.2)] flex gap-[8px] items-center justify-center px-[16px] py-[12px] rounded-[4px] w-full hover:opacity-90 transition-opacity cursor-pointer border-none">
