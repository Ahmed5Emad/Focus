    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-6">
      <div className="bg-card rounded-xl p-3 sm:p-6 shadow-sm border">
        <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-6">
          ...
          <div>
            <h3 className="text-sm md:text-lg font-semibold">Email & Push Notifications</h3>
            <p className="text-xs md:text-sm text-muted-foreground">Control how and when you receive notifications.</p>
          </div>
        </div>

        {notifPrefsLoading ? (
          <div className="space-y-3 md:space-y-4">
            <Skeleton className="h-9 md:h-12 w-full rounded-lg" />
            <Skeleton className="h-9 md:h-12 w-full rounded-lg" />
            <Skeleton className="h-9 md:h-12 w-full rounded-lg" />
          </div>
        ) : notifPrefs ? (
