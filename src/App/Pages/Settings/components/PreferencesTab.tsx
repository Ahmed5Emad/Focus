    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-6">
      <div className="bg-card rounded-xl p-3 sm:p-6 shadow-sm border">
        <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-6">
          ...
          <div>
            <h3 className="text-sm md:text-lg font-semibold">Task Defaults</h3>
            <p className="text-xs md:text-sm text-muted-foreground">Configure default behavior for new tasks.</p>
          </div>
        </div>
      ...
      <div className="bg-card rounded-xl p-3 sm:p-6 shadow-sm border">
        <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-6">
          ...
          <div>
            <h3 className="text-sm md:text-lg font-semibold">Project Defaults</h3>
            <p className="text-xs md:text-sm text-muted-foreground">Manage how projects behave by default.</p>
          </div>
        </div>
