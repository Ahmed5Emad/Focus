...
import { Loader2, Camera, Edit2, Folder, Settings as SettingsIcon } from 'lucide-react';
  ...
  return (
    <div className="w-full p-4 md:p-6 space-y-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">Manage your team's digital environment, security, and brand presence.</p>
      </div>
