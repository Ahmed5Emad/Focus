...
const TeamMember = ({ name, role }: { name: string; role: string }) => (
  <div className="flex flex-col gap-4">
    <div className="aspect-3/4 rounded-xl bg-linear-to-tr from-muted to-muted flex items-center justify-center overflow-hidden">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-1 flex flex-col items-center w-full">
        ...
        <div className="w-full max-w-24 h-px bg-border mb-24"></div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 w-full">
            ...
            <Link to="/careers" className="group flex flex-col gap-4">
              <div className="aspect-3/4 rounded-xl bg-foreground dark:bg-card flex flex-col items-center justify-center overflow-hidden relative transition-all duration-500">
                ...
                <span className="z-10 text-primary font-bold text-lg tracking-tight">
                  Join the mission
                </span>
              </div>
              <div className="flex flex-col">
